...
export default function Cart({ children }) {
  ...
  return (
    <>
      <section className="py-5 sm:py-7 bg-blue100">
        ...
        <div className="container max-w-screen-xl mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <main className="md:w-3/4">
              <div className="border border-gray200 bg-white shadow-sm rounded mb-5 p-3 lg:p-5">
                      ...
                      <div className="flex lg:flex-row gap-5 mb-4 md:flex-row justify-between ">
                        ...
                        <div className="flex gap-8 w-full justify-end md:flex-row">
                          ...
                          <div className="">
                            ...
                            <button
                              className="px-4 py-2 inline-block text-red600 bg-white shadow-sm border border-gray200 rounded-md hover:bg-gray100 cursor-pointer"
                              onClick={() =>
            ...
            <div className="md:w-1/4">
              <div className="border border-gray200 bg-white shadow-sm rounded mb-5 p-3 lg:p-5">
                <div className="mb-5">
                  <small className="flex justify-between text-gray600  mb-1">
